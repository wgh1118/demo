package com.wanggh.exercise.distrbuted.zk;
 ...
 * @since 2015-6-14
 */
public class ZooKeeperWatcherYuCong implements Watcher {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ZooKeeperWatcherYuCong zkWatch = new ZooKeeperWatcherYuCong();
        //创建连接 
        ...
        if (zkWatch.createPath(PARENT_PATH, System.currentTimeMillis() + "", false)) {
            ...
            // 读取数据
            zkWatch.readData(PARENT_PATH, false);
            ...
            // 创建子节点
            zkWatch.createPath(CHILDREN_PATH, System.currentTimeMillis() + "", false);
